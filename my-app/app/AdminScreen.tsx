...
const PantallaAdministrador = () => {
  ...
  const fetchData = async () => {
    try {
      const [
        ...
        axios.get('http://10.0.50.146/conex/AbmlActions.php?action=fetchData&table=equipos'),
        axios.get('http://10.0.50.146/conex/AbmlActions.php?action=fetchData&table=jugadores'),
        axios.get('http://10.0.50.146/conex/AbmlActions.php?action=fetchData&table=partidos'),
        axios.get('http://10.0.50.146/conex/AbmlActions.php?action=fetchData&table=jugadoresaccess'),
        axios.get('http://10.0.50.146/conex/AbmlActions.php?action=fetchData&table=seguidores'),
      ]);
  ...
  const insertarDatos = async (tabla: string, datos: any) => {
    try {
      await axios.post('http://10.0.0.42/conex/AbmlActions.php?action=insertData', { tabla, datos });
      fetchData();
    } catch (error) {
  ...
  const actualizarDatos = async (tabla: string, datos: any, id: number) => {
    try {
      await axios.post('http://10.0.50.146/conex/AbmlActions.php?action=updateData', { tabla, datos, id });
      fetchData();
    } catch (error) {
  ...
  const eliminarDatos = async (tabla: string, id: number) => {
    try {
      await axios.post('http://10.0.50.146/conex/AbmlActions.php?action=deleteData', { tabla, id });
      fetchData();
    } catch (error) {
