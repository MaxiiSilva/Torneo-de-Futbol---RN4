...
const Jugadores = () => {
    ...
    const mostrarInfoKYC = () => {
        Alert.alert("¿Qué es Clave AFA?", "La Clave AFA es un método de acceso exclusivo destinado a los jugadores de la competición, el cual es proporcionado por la Asociación Organizadora a los clubes participantes. Para obtener esta Clave AFA, un representante autorizado del club debe solicitar la credencial correspondiente para aquellos jugadores que necesiten acceder a la aplicación. Este acceso les permitirá acceder a su información en la competicion de manera segura.")
    };
    ...
    return (
        <View style={styles.containerFondo}>
            <View style={styles.container}>
                <Image
                    source={require('C:/Users/Maxi Silva/Desktop/torneo/my-app/assets/images/copa.png')}
                    style={styles.logo}
                />
                ...
                <TouchableOpacity onPress={mostrarInfoKYC} style={styles.kycButton}>
                    <Text style={styles.kycText}>¿Qué es Clave AFA?</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
